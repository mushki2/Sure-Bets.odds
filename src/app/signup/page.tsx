    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] p-4 bg-gray-50">
      <Card className="w-full max-w-md shadow-xl border-none">
        <CardHeader className="pt-8 text-center">
          <h2 className="text-3xl font-black text-blue-900 tracking-tight">Join SureBets Odds</h2>
          <p className="text-gray-500 mt-2 font-medium">Start getting smarter predictions today</p>
        </CardHeader>
        <CardContent className="px-8 mt-2">
          <form onSubmit={handleEmailSignup} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Confirm Password</label>
              <input
                type="password"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase font-bold text-gray-400">
              <span className="bg-white px-4 tracking-widest">Or sign up with</span>
            </div>
          </div>
        ...
        <CardFooter className="pb-8 text-center justify-center">
          <p className="text-sm text-gray-500 font-medium">
            Already have an account? <Link href="/login" className="text-blue-600 hover:text-blue-700 font-bold underline underline-offset-4 decoration-2">Sign in here</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
